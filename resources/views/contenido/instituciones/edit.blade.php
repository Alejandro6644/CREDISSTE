...
@section('content')
    ...
    ">
        ...
        <div class="cuerpo">
            ...
            {!! Form::open(['method' => 'PATCH', 'url' => '/instituciones/' . $institucion->encrypt_id]) !!}

            <section>
                {!! Form::label('nombre', 'Nombre de la institucion:') !!}
                {!! Form::text('nombre', $institucion->nombre, [
            ...
            <section>
                {!! Form::label('id_estado', 'estado de la institucion:') !!}
                {!! Form::select('id_estado', $estados->pluck('nombre', 'encrypt_id')->all(), $institucion->estado->encrypt_id, [
            ...
            <section>
                ...
                {!! Form::select('status', ['1' => 'Activo', '0' => 'Baja'], $institucion->status, [
                    'class' => 'form-control border-primary text-primary bg-light',
                    'placeholder' => 'Seleccionar ...',
                    'required',
                ]) !!}
        ...
        <div class="pie">
            {!! Form::submit('Guardar institucion', ['class' => 'btn btn-success']) !!}
            {!! Form::close() !!}
        </div>
