...
@section('content')
    ...
    <div class="container-fluid mt-4 principal rounded
        ...
        <div class="w-100 cabecera">
            <a href="{!! 'detallePagos/create' !!}">
                <p class="h2">Crear Detalle de pago</p>
            </a>
        </div>
                ...
                <tbody id="tabla-body">
                    @foreach ($detalle_pagos as $detalle_pago)
                        <tr class="content-row">
                            ...
                            <td>
                                <div class="flex">
                                    <a href="{!! 'detallePagos/' . $detalle_pago->encrypt_id !!}"
                                        class="badge badge-pill badge-success botones alinear-centro">Detalle</a>
                                    <a href="{!! 'detallePagos/' . $detalle_pago->encrypt_id . '/edit' !!}"
                                        class="badge badge-pill badge-success botones alinear-centro">Editar</a>
                                    {!! Form::open(['method' => 'DELETE', 'url' => '/detallePagos/' . $detalle_pago->encrypt_id]) !!}
