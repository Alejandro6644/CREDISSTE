...
@section('content')
    ...
    ">
        ...
        <div class="cuerpo">
            {!! Form::open(['method' => 'PATCH', 'url' => '/users/' . $user->encrypt_id]) !!}
            <section>
                {!! Form::label('primer_nombre', 'Nombre de la persona:') !!}
                {!! Form::text('primer_nombre', $user->primer_nombre, [
            ...
            <section>
                ...
                {!! Form::text('segundo_nombre', $user->segundo_nombre, [
                    'class' => 'form-control border-primary text-primary bg-light',
            ...
            <section>
                ...
                {!! Form::text('primer_apellido', $user->primer_apellido, [
                    'class' => 'form-control border-primary text-primary bg-light',
            ...
            <section>
                ...
                {!! Form::text('segundo_apellido', $user->segundo_apellido, [
                    'class' => 'form-control border-primary text-primary bg-light',
            ...
            <section>
                ...
                {!! Form::text('id_trabajador', $user->id_trabajador, [
                    'class' => 'form-control border-primary text-primary bg-light',
            ...
            <section>
                ...
                {!! Form::select(
                    'id_pais',
                    $paises->pluck('nombre', 'encrypt_id')->all(),
                    $user->municipio->estado->pais->encrypt_id,
                    [
            ...
            <section>
                ...
                {!! Form::select(
                    'id_estado',
                    $estados->pluck('nombre', 'encrypt_id')->all(),
                    $user->municipio->estado->encrypt_id,
                    [
                        'class' => 'form-control border-primary text-primary bg-light select-3rem',
                        'placeholder' => 'Seleccionar ...',
                        'required',
            ...
            <section>
                ...
                {!! Form::select(
                    'id_municipio',
                    $municipios->pluck('nombre', 'encrypt_id')->all(),
                    $user->municipio->encrypt_id,
                    [
                        'id' => 'id_municipio',
                        'class' => 'form-control border-primary text-primary bg-light select-3rem',
                        'placeholder' => 'Seleccionar ...',
            ...
            <section>
                ...
                {!! Form::select(
                    'id_institucion',
                    $instituciones->pluck('nombre', 'encrypt_id')->all(),
                    $user->institucion->encrypt_id,
                    [
                        'class' => 'form-control border-primary text-primary bg-light select-3rem',
                        'placeholder' => 'Seleccionar ...',
                        'required',
            ...
            <section>
                ...
                {!! Form::select('id_role', $roles->pluck('nombre', 'encrypt_id')->all(), $user->role->encrypt_id, [
                    'class' => 'form-control border-primary text-primary bg-light select-3rem',
                    'placeholder' => 'Seleccionar ...',
                    'required',
                ]) !!}
