...
@section('content')
    ...
    ">
        ...
        <div class="cuerpo">
            {!! Form::open(['method' => 'PATCH', 'url' => '/pagos/' . $pago->encrypt_id]) !!}

            <section>
                {!! Form::label('identificador', 'Identificador del pago:') !!}
                {!! Form::text('identificador', $pago->identificador, [
            ...
            <section>
                ...
                {!! Form::number('sueldoBruto', $pago->sueldoBruto, [
                    'id' => 'sueldoBruto',
                    'class' => 'form-control border-primary text-primary bg-light',
            ...
            <section>
                ...
                {!! Form::number('descuentos', $pago->descuentos, [
                    'id' => 'descuentos',
                    'class' => 'form-control border-primary text-primary bg-light',
            ...
            <section>
                ...
                {!! Form::number('sueldoNeto', $pago->sueldoNeto, [
                    'id' => 'sueldoNeto',
                    'class' => 'form-control border-primary text-primary bg-light',
            ...
            <section>
                ...
                {!! Form::select('status', ['1' => 'Activo', '0' => 'Baja'], $pago->status, [
                    'class' => 'form-control border-primary text-primary bg-light',
