                ...
                <tbody id="tabla-body">
                    @foreach ($pagos as $pago)
                        <tr class="content-row">
                            ...
                            <td>
                                <span class="content-data">
                                    {!! \Carbon\Carbon::parse($pago->fechaEmision)->format('d-m-Y') !!}
                                </span>
                            </td>
                            <td>
                                <span class="content-data">
