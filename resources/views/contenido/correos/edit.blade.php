...
@section('content')
    ...
    ">
        ...
        <div class="cuerpo">
            {!! Form::open(['method' => 'PATCH', 'url' => '/correos/' . $correo->encrypt_id]) !!}

            <section>
                {!! Form::label('origen', 'origen del correo:') !!}
                {!! Form::email('origen', $correo->origen, [
            ...
            <section>
                ...
                {!! Form::email('destinatario', $correo->destinatario, [
                    'class' => 'form-control border-primary text-primary bg-light',
            ...
            <section>
                ...
                {!! Form::text('contenido', $correo->contenido, [
                    'class' => 'form-control border-primary text-primary bg-light',
            ...
            <section>
                ...
                {!! Form::select('status', ['1' => 'Activo', '0' => 'Baja'], $correo->status, [
                    'class' => 'form-control border-primary text-primary bg-light',
