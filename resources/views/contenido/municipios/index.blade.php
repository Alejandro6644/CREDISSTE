                ...
                <tbody id="tabla-body">
                    @foreach ($municipios as $municipio)
                        <tr class="content-row">
                            ...
                            <td>
                                <div class="flex">
                                    <a href="{!! 'municipios/' . $municipio->encrypt_id !!}"
                                        class="badge badge-pill badge-success botones alinear-centro">Detalle</a>
                                    <a href="{!! 'municipios/' . $municipio->encrypt_id . '/edit' !!}"
                                        class="badge badge-pill badge-success botones alinear-centro">Editar</a>
                                    {!! Form::open(['method' => 'DELETE', 'url' => '/municipios/' . $municipio->encrypt_id]) !!}
